...
The `loopx anki` implementation is adapted from the tool layer of
...
LoopX removes the NestJS and MCP transport layers while preserving those behavioral and safety
contracts in `packages/loopx/src/builtins/anki`.
