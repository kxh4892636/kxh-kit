...
jwt.sign({ foo: "bar" }, privateKey, { algorithm: "HS256", expiresIn: 60 }, function (err, token) {
...
```typescript
export const generateToken = (name: string, expiresMinutes?: number): Promise<Error | string> => {
...
export const parseToken = (token: string): Promise<Error | jwt.JwtPayload | string> => {
  return new Promise((resolve, reject) => {
