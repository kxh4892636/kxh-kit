---
name: nano-mem
description: 主动使用 nnm CLI 检索并维护任何可能帮助任务的本地 agent 记忆；将记忆的读写视为一体两面：当目标与理由、决策与约束、领域或架构知识、实现卡点、错误与修复、成功或失败经验、环境与工具陷阱、验证方式、未完事项、用户偏好或习惯可能形成或影响当前工作时，先检索并使用相关记忆，再立即记住新信息；也用于纠正、强化、遗忘、恢复或删除。
---
