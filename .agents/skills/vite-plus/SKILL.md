---
name: vite-plus
description: Vite+ unified web toolchain reference. Use when working with vp runtime or package management, project creation or migration, development checks and tests, builds or packaging, monorepo task execution, or vite.config.ts configuration.
---
