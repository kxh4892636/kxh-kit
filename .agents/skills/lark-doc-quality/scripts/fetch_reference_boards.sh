#!/usr/bin/env bash
# Pull reference whiteboards from the official chart reference docx
# and sink them into skills/lark-doc-quality/assets/{previews,raw}/.
#
...
OUT_DIR="$ROOT/skills/lark-doc-quality/assets"
