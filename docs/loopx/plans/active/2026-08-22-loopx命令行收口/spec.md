...
| #   | Issue                                                   | 状态        | 阻塞于                     | 下一步     |
| --- | ------------------------------------------------------- | ----------- | -------------------------- | ---------- |
| 01  | [CLI kernel 与本地 npm 包](01-CLI-kernel与本地npm包.md) | in_progress | —                          | /implement |
| 02  | [Skill 目录与版本检测](02-Skill目录与版本检测.md)       | pending     | 01                         | /implement |
| 03  | [Skill 安装生命周期](03-Skill安装生命周期.md)           | pending     | 02                         | /implement |
