...
| #   | Issue                                          | 状态      | 阻塞于 | 下一步         |
| --- | ---------------------------------------------- | --------- | ------ | -------------- |
| 01  | [搜索工具与配置实现](01-搜索工具与配置实现.md) | completed | —      | /code-delivery |
| 02  | [抓取工具实现](02-抓取工具实现.md)             | completed | 01     | /code-delivery |
| 03  | [安装配置与真机验证](03-安装配置与真机验证.md) | completed | 01, 02 | /code-delivery |
