...
| #   | Issue                                                                | 状态        | 阻塞于 | 下一步         |
| --- | -------------------------------------------------------------------- | ----------- | ------ | -------------- |
| 01  | [建立 Pi package 与全局配置契约](01-建立pi-package与全局配置契约.md) | in_progress | —      | /code-delivery |
| 02  | [交付 DeepSeek 原生网页搜索](02-交付deepseek原生网页搜索.md)         | pending     | 01     | /code-delivery |
| 03  | [建立公共网页抓取安全传输](03-建立公共网页抓取安全传输.md)           | pending     | 01     | /code-delivery |
