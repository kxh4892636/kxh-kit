...
`nf anki` 完整承载笔记和笔记类型的查询、创建、修改和删除能力，所有业务输入均通过命名 option 表达。
...
验证证据：Nano Flow 97/97、旧 anki-cli 168/168；Nano Flow build/check 通过，全仓 check 0 error（31 个既有 warning）；dangling commit `bcac23237a4b246d482a635a5809d275a0d76f82` 的 Standards/Spec 双轴复审均无 blocker。
