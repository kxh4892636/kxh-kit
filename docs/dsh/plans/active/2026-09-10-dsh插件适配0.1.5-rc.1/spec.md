...
| #   | Issue                                                  | 状态    | 阻塞于 | 下一步         |
| --- | ------------------------------------------------------ | ------- | ------ | -------------- |
| 01  | [历史文本化修复与 chunk 行去除](01-历史文本化修复.md)  | pending | —      | /code-delivery |
| 02  | [依赖声明与文档对齐](02-依赖声明与文档对齐.md)         | pending | —      | /code-delivery |
| 03  | [合入主分支并推送](03-合入主分支并推送.md)             | pending | 01, 02 | /code-delivery |
