...
| #   | Issue | 状态 | 阻塞于 | 下一步 |
| --- | --- | --- | --- | --- |
| 01 | [spawn 重构抽 seam(prefactoring)](01-spawn重构抽seam.md) | in_progress | — | /code-delivery |
| 02 | [spawn 默认 workspace = 调用方会话](02-spawn默认workspace.md) | pending | 01 | /code-delivery |
| 03 | [会话上下文系统消息注入](03-会话上下文系统消息注入.md) | pending | 01 | /code-delivery |
