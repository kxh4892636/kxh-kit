...
| #   | Issue                                                             | 状态        | 阻塞于 | 下一步     |
| --- | ----------------------------------------------------------------- | ----------- | ------ | ---------- |
| 01  | [`idle`/`done` 限流停顿续跑纵切](01-idle-done限流停顿续跑纵切.md) | in_progress | —      | /implement |
| 02  | [`blocked` 限流停顿续跑](02-blocked限流停顿续跑.md)               | pending     | 01     | /implement |
| 03  | [状态事件自动续跑](03-状态事件自动续跑.md)                        | pending     | 02     | /implement |
