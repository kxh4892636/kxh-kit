...
const DEFAULT_PROJECT_ID = process.env.HUATUO_PROJECT_ID || '141';
...
function usage() {
  return `Usage:
  node huatuo_coverage_report.mjs
  node huatuo_coverage_report.mjs --branch test/bits2
  node huatuo_coverage_report.mjs --repo <repo-path> --mr-id 553
  node huatuo_coverage_report.mjs --repo <repo-path> --mr-id 553 --file-path apps/foo/index.tsx
...
Options:
  ...
  --mr-id <id>             MR id
  --project-id <id>        Project id, defaults to HUATUO_PROJECT_ID or 141
