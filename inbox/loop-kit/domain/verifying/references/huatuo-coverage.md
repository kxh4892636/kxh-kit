...
```bash
node .agents/skills/loop-kit/domain/verifying/scripts/huatuo_coverage_report.mjs --branch test/bits2
node .agents/skills/loop-kit/domain/verifying/scripts/huatuo_coverage_report.mjs --repo <repo-path> --mr-id 553
node .agents/skills/loop-kit/domain/verifying/scripts/huatuo_coverage_report.mjs --repo <repo-path> --mr-id 553 --json
```
...
node .agents/skills/loop-kit/domain/verifying/scripts/huatuo_coverage_report.mjs \
  --repo <repo-path> \
  --mr-id 553 \
  --file-path apps/penalty-ecop-pc/src/pages/disposal-auth/index.tsx
```
